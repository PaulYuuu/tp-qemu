...
class BlockdevCommitServerDown(BlockDevCommitTest):
    def __init__(self, test, params, env):
        ...
        params["images"] += " {}".format(params["nbd_image_tag"])
    ...
    def check_commit_running(self):
        ...
        for i in range(tmo):
            ...
            self.test.fail(f"offset is 0 after {tmo} seconds")
    ...
    def check_commit_process(self):
        ...
        for i in range(tmo):
            ...
            if offset is None:
                ...
                self.test.fail(
                    "offset changed: {} vs. {}".format(offset, job["offset"])
                )
        # resume nbd access
        self.nbd_export.export_image()
    ...
    def post_test(self):
        self.params["images"] += " {}".format(self.params.get("local_image_tag"))
        self.nbd_export.stop_export()
        super().post_test()
