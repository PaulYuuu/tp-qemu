...
def run(test, params, env):
    ...
    error_context.context(f"Copy {tcpreplay_file_name} to {tmp_dir}", test.log.info)
    ...
    if success_packet != 1:
        test.fail(f"tcpreplay result error with output: {output}")
