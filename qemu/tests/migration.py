...
def run(test, params, env):
    ...
    def guest_stress_start(guest_stress_test):
        ...
        if guest_stress_test == "autotest":
            ...
            new_params["test_control_file"] = f"{test_type}.control"
    ...
    if mig_exec_cmd_src and "gzip" in mig_exec_cmd_src:
        ...
        mig_exec_file += f"-{utils_misc.generate_random_string(8)}"
        ...
        try:
            ...
            for i in range(int(ping_pong)):
                ...
                try:
                    ...
                    test.cancel(f"Unable to access capability: {e}")
                except:
                    raise
            ...
            if output != reference_output:
                ...
                test.fail(
                    f"Command '{test_command}' produced different output "
