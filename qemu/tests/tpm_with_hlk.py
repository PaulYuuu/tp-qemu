...
def run(test, params, env):
    ...
    params[f"images_{vm_name_hlk_server}"] = "image0"
    params[f"image_name_image0_{vm_name_hlk_server}"] = server_img["image_name"]
    params[f"image_size_image0_{vm_name_hlk_server}"] = server_img["image_size"]
    params[f"image_format_image0_{vm_name_hlk_server}"] = server_img["image_format"]
