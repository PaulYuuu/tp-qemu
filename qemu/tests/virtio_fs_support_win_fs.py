...
def run(test, params, env):
    ...
    copy_cmd = f"xcopy {winutils_pack_path} {shared_driver_letter}:\\ /Y"
    ...
    result_on_shared = f"{shared_driver_letter}:\\result.txt"
    error_context.context(
    ...
    if (
        "7-zip" in output_lower
        and "setup" in output_lower
        ...
        test.fail(
            "Error detected while installing the "
