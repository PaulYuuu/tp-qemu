...
class BlkdevIncNoBitmapmode(blockdev_base.BlockdevBaseTest):
    ...
    def _init_arguments_by_params(self, tag):
        ...
        self.inc_backups.append(f"drive_{image_chain[1]}")
    ...
    def do_incremental_backup(self):
        ...
        try:
            ...
            self.test.fail("Inc backup without bitmap mode")
...
def run(test, params, env):
    """
    Incremental live backup without bitmap mode
    ...
    test steps:
        ...
        6). do inc bakcup(sync: bitmap and withoout bitmap-mode)

    :param test: test object
    :param params: test configuration dict
    :param env: env object
    """
    inc_no_bpmode = BlkdevIncNoBitmapmode(test, params, env)
