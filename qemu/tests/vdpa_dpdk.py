...
def run(test, params, env):
    ...
    for forward in forward_mode.split():
        result_file.write(f"Category:{forward}\n")
        ...
        for pkts in dpdk_pkts.split():
            for queue in dpdk_queues.split():
                ...
                line = f"{format_result(pkts, base, fbase)}|"
                line += f"{format_result(queue, base, fbase)}|"
                line += f"{format_result(pps, base, fbase)}|"
                line += f"{format_result(mpps, base, fbase)}|"
