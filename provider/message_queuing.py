...
class MessageNotFoundError(Exception):
    ...
    def __str__(self):
        return (
            f'No matching message("{self.message}") was found. '
...
class UnknownEventError(Exception):
    ...
    def __str__(self):
        return f'Got unknown event: "{self.event}"'
...
class MQBase(client.Expect):
    ...
    def _monitor_message(self, message, timeout=DEFAULT_MONITOR_TIMEOUT):
        ...
        try:
            ...
            LOG_JOB.info(f'The message "{message}" has been monitored.')
...
class MQClient(MQBase):
    ...
    def filter_msg(self, msgs=None, timeout=DEFAULT_MONITOR_TIMEOUT):
        ...
        try:
            ...
            if output:
                LOG_JOB.debug(f'Monitor The message "{output}"')
                return output[0]
